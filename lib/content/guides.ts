...
export const GUIDES: Guide[] = [
  {
    ...
    tips: [
      ...
      { h: "Answer the actual brief", p: "Reference the specific role, genre, and deadline they posted. A tailored two-line pitch beats a generic paragraph every time — it shows you read it and you're available for this." },
      { h: "Show you can hit the deadline", p: "Say it plainly: ‘I can deliver the two stems by the 14th.’ Reliability is the #1 thing owners are scared about — remove the doubt up front." },
  ...
  },
  {
    ...
    tips: [
      { h: "Set up payouts before you need them", p: "Connect your bank in Settings → Payouts. An owner can't fund an escrow to you until your payout account is verified — do it once, up front." },
  ...
  },
  {
    ...
    tips: [
      ...
      { h: "Collect rating dimensions", p: "Ratings break down into communication, timeliness, and musical fit. Be strong across all three, not just talent — that's what de-risks hiring you." },
